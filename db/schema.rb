...
ActiveRecord::Schema.define(version: 5) do
  ...
  create_table "access_codes", force: :cascade do |t|
    ...
    t.index ["client_id"], name: "index_access_codes_on_client_id", using: :btree
    t.index ["resource_owner_id"], name: "index_access_codes_on_resource_owner_id", using: :btree
    t.index ["token"], name: "index_access_codes_on_token", unique: true, using: :btree
  end
